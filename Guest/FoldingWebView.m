...
-(instancetype)initWithFrame:(CGRect)frame request:(NSURLRequest *)request{
    ...
    if (self) {
        ...
        [_backButton setBackgroundImage:[UIImage imageNamed:@"previous"] forState:UIControlStateNormal];
        ...
        [_forwardButton setBackgroundImage:[UIImage imageNamed:@"forward"] forState:UIControlStateNormal];
